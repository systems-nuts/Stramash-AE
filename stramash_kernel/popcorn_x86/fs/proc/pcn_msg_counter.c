...
unsigned long long yield_level;
...
static ssize_t
yield_level_write(struct file *filp, const char __user *ubuf,
...
static struct file_operations kvm_file_ops =      
{
        .open = yield_level_open,
        .read = seq_read,
        .write = yield_level_write,
};
