				 ...
				 int flags)
{
	...
	printk("phys_addr %lx size %lx virt %lx\n",phys,size,virt);
	printk("phys-PHYS_OFFSET %lx, PHYS_OFFSET %lx\n",phys-PHYS_OFFSET, PHYS_OFFSET);
	/*
...
static void __init map_mem(pgd_t *pgdp)
{
	...
	/* Stramash test of shared virtual address */
		printk("%lx start %lx end\n",start,end);
		if (start >= end)
			break;
