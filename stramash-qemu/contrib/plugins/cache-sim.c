...
#define new_L3(typ, nr) ((typ *)new_shared_L3(sizeof(typ) * (nr)))
                            ...
                            uint64_t vaddr, void *userdata)
{
    ...
    if (!hit_in_l3)
    {
        ...
        if(test==SHM)
        {
                if (effective_addr >= 0x100000000 && effective_addr < 0x150000000)
                {
...
static void shm_init()
{
    ...
    // hard coded
    void *preferred_address_L1_L2 = (void *)0x5000000;
...
{    
    ...
    l1_dassoc = 4;
    l1_dblksize = 64;
    l1_dcachesize = l1_dblksize * l1_dassoc * 256;

    l1_iassoc = 8;
    l1_iblksize = 64;
    l1_icachesize = l1_iblksize * l1_iassoc * 256;
